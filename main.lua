...
f.bar = CreateFrame("StatusBar", "ReverseStatusBarBug_Bar", f)
f.bar:SetAllPoints(f)
f.bar:SetMinMaxValues(0, 1)
f.bar:SetValue(0)
f.bar:SetOrientation("VERTICAL")
f.bar:SetStatusBarTexture("Interface\\AddOns\\ReverseStatusBarBug\\bar")
...
-- f.bar:SetFillStyle(Enum.StatusBarFillStyle.Center)
